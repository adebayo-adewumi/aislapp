...
const TextInput: ForwardRefRenderFunction<MyInputHandles, ITextInput> = (
  ...
  const getClassName = (...classNames: string[]) => classNames.join(" ");
  ...
  function renderRightElement() {
    if (secure) {
      return (
        ...
        >
          {
            <span style={{ cursor: "pointer" }} onClick={toggleSecureEntry}>
