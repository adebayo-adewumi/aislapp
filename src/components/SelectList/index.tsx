...
import { MyInputHandles } from "../Input/index";

export interface ISelectList {
  data?: Array<{ val: string; desc: string }>;
  label?: string;
  ...
  return (
    <div>
      ...
      <select
        ...
        style={{
          ...{
            ...
            fontSize: 14,
            borderRadius: 10,
            backgroundColor: editable ? "#ffff" : "black",
      ...
      >
        ...
        {data?.map((d, i) => (
          <option value={d.val} selected={d.val === selectedValue}>
            {d.desc}
          </option>
        ))}
      </select>
