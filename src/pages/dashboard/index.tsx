                        ...
                        <div className="card md:w-2/5 w-full md:p-5 px-3 py-3 md:mb-0 mb-6">
                            <Link to={"/stock?name=" + el.name + "&sector=" + el.sector + "&symbol=" + el.stockCode + "&sign=" + (el.sign === '+' ? 'positive' : 'negative') + "&change=" + el.change + "&close=" + el.close + "&open=" + el.open + "&high=" + el.high + "&low=" + el.low + "&wkhigh=" + el.weekHigh52 + "&wklow=" + el.weekLow52 + "&volume=" + el.volume + "&mktsegment=" + el.mktSegment + "&pclose=" + el.pclose} className='no-underline' key={index}>
                                ...
                                <div className="flex w-full justify-between space-x-5 md:mb-0 md:text-sm text-xs">
                                    <div className="font-bold text-gray-900 md:text-sm text-xs">{el.stockCode}</div>
                ...
                .then(function (response) {
                    ...
                    const newsItem = takeNews.map((item: any, index :any) =>
                        <a href={item.url === null || item.url === '' ? '#': item.url} className='no-underline' target="_blank" key={index} rel="noreferrer">
                            <div className="flex justify-between md:space-x-5 space-x-3  md:mb-0 mb-11" style={{width: '23rem'}}>
                                <div className='news-width'>
                                    <div className="font-bold md:text-sm text-xs mb-10 text-black">{item.title}</div>
                                    ...
                                    <div className="font-bold md:text-sm text-xs text-black mb-10">&middot; {moment(item.date).format("MMM Do YYYY, hh:ss a")}</div>
                                </div>
        ...
        <div className="relative">
            ...
            <div>
                <div className="flex">
                    ...
                    <div className="main-content md:ml-64 w-full p-10">
                        ...
                        <div className="mb-32">
                            ...
                            <div className="md:flex news-section md:justify-between md:space-x-5">
                                {newsList}
                            </div>
                        </div>
                        {/* End */}
