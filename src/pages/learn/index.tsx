                ...
                <div className="flex">
                    ...
                    <div className="main-content w-full p-10">
                        <div className="text-28 mb-10">
                            <span className="font-bold text-color-1">Learning Centre</span>
                        </div>

                        <div className="text-16 font-bold text-color-2 mb-12">Explore curated resources on how to trade stocks</div>
                        ...
                        <div className='mb-14'>
                            <div className='mb-30 flex justify-between items-center'>
                                <div className="border_1 flex rounded-lg p-02rem">
                                    <div>
                                        <button onClick={performSwitchToLearn} type='button' className={switchToLearn ? "rounded-lg bgcolor-1 text-white border-0 py-3 px-12 font-bold cursor-pointer":"cursor-pointer rounded-lg py-3 px-12 font-bold border-0 bgcolor-f"}>Learn</button>
                                    </div>

                                    <div className='hidden'>
                                        <button onClick={performSwitchToSupport} type='button' className={switchToSupport ? "rounded-lg bgcolor-1 text-white border-0 py-3 px-12 font-bold cursor-pointer":"cursor-pointer rounded-lg py-3 px-12 font-bold border-0 bgcolor-f"}>Support</button>
                                    </div>

                                    <div>
                                        <button onClick={performSwitchToContactUs}  type='button' className={switchToContactUs ? "rounded-lg bgcolor-1 text-white border-0 py-3 px-12 font-bold cursor-pointer":"cursor-pointer rounded-lg py-3 px-12 font-bold border-0 bgcolor-f"}>Contact Us</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={switchToLearn ? '':'hidden'}>
                            ...
                            <div className='px-14 pb-16 search-bg mb-14'>
                                <div>
                                    <div style={{fontSize : '49px'}} className='mb-30 font-gotham-black-regular text-color-1 text-center font-bold'>How can we help you?</div>
                                </div>

                                <div className='flex space-x-3 mx-auto mb-20' style={{width : '50rem'}}>
                                    <div className='w-3/4'>
                                    ...
                                    <div>
                                        <button className='bgcolor-1 rounded-lg text-white border-0 px-10 font-bold py-4'>Search</button>
                                    </div>
                                </div>
                            ...
                            <div className={showLearningResource ? '':'hidden'}>
                                <div className=''>
                                    <div className='flex justify-between items-center text-center mx-auto' style={{width: '30rem'}}>
                                        <div style={{fontSize : '30px'}} className='mb-10 font-gotham-black-regular text-color-1 text-center font-bold'>Knowledge Base</div>
                                        
                                        <div className='cursor-pointer'>
                                            <a href='/learn' className='no-underline text-color-1'>
                                    ...
                                    <div style={{fontSize : '15px'}} className='mb-30 text-color-1 text-center'>Browse articles to find answers and troubleshooting tips.</div>                               
                                </div>
                            ...
                            <div className='hidden'>
                                <div className=''>
                                    <div style={{fontSize : '30px'}} className='mb-10 font-gotham-black-regular text-color-1 text-center font-bold'>Frequently asked questions</div>

                                    <div style={{fontSize : '15px'}} className='mb-30 text-color-1 text-center'>Browse our FAQs to find quick answers to your questions</div>                               
                                </div>
                        ...
                        <div className={switchToSupport ? '':'hidden'}>
                            <div className=''>
                                <div style={{fontSize : '30px'}} className='mb-10 font-gotham-black-regular text-color-1 text-center font-bold'>Raise a ticket</div>

                                <div style={{fontSize : '15px'}} className='mb-30 text-color-1 text-center'>We are here to help you, send us a message and we’ll respond in a short while</div>                               
                            </div>
                            ...
                            <div className='rounded shadow-sm bg-white border border-gray-500 p-10 mx-auto' style={{width: '50rem'}}>
                                ...
                                <div>
                                    <div className='text-right'>
                                        <button className='bgcolor-1 text-white rounded-lg font-bold px-16 py-5 border-0 cursor-pointer'>Submit</button>
                                    </div>
                                </div>
                            </div> 
