            ...
            <div className='h-screen m-0'>              
                ...
                <div className='min-w-0 h-full'>
                    <div className='relative h-full'>
                        <div className={showResetPasswordCard ? 'relative h-full':'hidden'}>
                            <div className="mx-auto reset-container top-32">

                                <div className="mb-3 text-3xl font-gotham-black-regular text-green-900">Reset your password</div>
                                
                                <div className="mb-8 text-sm text-green-900">Please type a new password</div>
                                ...
                                <form className="form">
                                    ...
                                    <div className="mb-3">
                                        <div className="relative">
                                            <div className="mb-3 text-sm font-bold">Create a new password</div>
                                            <div className='flex w-full items-center justify-between border rounded-lg p-1'>
                                                <div className='w-full'>
                                                    <input value={password} onChange={e => setPassword(e.target.value)} type={isShowPassword ? 'text' : 'password'} className="bg-white text w-full focus:outline-none px-3 py-3 rounded text-gray-900 focus:bg-white focus:ring-indigo-500" placeholder="Enter password" name="password"/>
                                                </div>
                                    ...
                                    <div className="text-right">
                                        <Link to="/" className="no-underline text-green-900 hover:text-green-900">Take me back to <span className="">Login </span></Link>
                                    </div>
                                </form>
                            </div>
                        </div>

                        <div className={showSuccessCard ? 'relative h-full':'hidden'}>
                            <div className="mx-auto reset-success-container top-32">
                                ...
                                <div>
                                    <Link to="/">
                                        <button className="bg-green-900 text-white rounded-lg p-3 w-full font-bold no-underline">Proceed to Login</button>                        
                                    </Link>
                                </div>
                            </div>
                        </div>
