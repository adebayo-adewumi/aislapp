...
const Login = () => {
    ...
    function loginUser(){
        ...
        if(localStorage.getItem('loginUserCypher')){
            ...
            axios.post('http://34.252.87.56:7930/api/login', 
            {
            ...
            .then(function (response) {
                ...
                auth.profile = response.data.data;

                navigate(from, { replace: true });

                localStorage.setItem('aislUserCustomerId', response.data.data.id);
                localStorage.setItem('aislUserToken', response.data.data.token);
                localStorage.setItem('aislUserFullname', response.data.data.firstName+' '+response.data.data.lastName);
                    ...
                    <div className="login-container">
                        ...
                        <form className="form">
                            <div className="mb-20">
                                ...
                                <input onChange={e => setEmail(e.target.value)} className="outline-white p-3 input text-14 border-1-d6" placeholder="Enter your email"/> 
