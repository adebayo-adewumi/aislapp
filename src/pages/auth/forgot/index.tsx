            ...
            <div className='h-screen m-0'>              
                ...
                <div className='min-w-0 h-full'>
                    <div className='relative h-full'>
                        ...
                        {/* VERIFY OTP Section */}
                        <div className={showVerifyOTPCard ? "mx-auto reset-password-link-confirmation-container" : "hidden"}>
                        ...
                        <div className={showResetPasswordCard ? "mx-auto reset-password-link-confirmation-container " : "hidden"}>
