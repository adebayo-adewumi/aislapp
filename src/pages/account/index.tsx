                ...
                <div className='generic-modal-dialog'>
                    <div className="account-balance-modal rounded-lg">
                        ...
                        <div className="wallet-balance-card mb-30">
                            ...
                            <div className="text-gray-300 text-sm leading-5">Money from your recent sell orders that is yet to reflect in available balance</div>
                        </div>
                        ...
                        <div className="wallet-balance-card mb-30">
                            ...
                            <div className="text-gray-300 leading-5 text-sm">This balance is money reserved for your queued Buy Orders</div>
                        </div>
                    </div>
                </div>
            </div>
