                        ...
                        <div className='p-10 flex-1 bg-gray-100 overflow-y-auto'>
                            <div className='m-auto w-42rem pt-12'>
                                ...
                                <div className="flex justify-between">
                                    <div>
                                        <div className="text-3xl text-green-900 font-gotham-black-regular font-bold mb-10">Investment Statements</div>
                                ...
                                <div>
                                    ...
                                    <div className={showStatement ? 'amount-section rounded-lg border-1-d6 bg-white p-10' : 'hidden'}>
                                        <div>
                                            ...
                                            <div className={statementError !== '' ? "error-alert mb-20" : "hidden"}>
                                                <div className="flex justify-between space-x-1 pt-3">
                                                    <div className="flex">
                                                        ...
                                                        <div className="pt-1 text-sm">{statementError}</div>
                                                    </div>
                                            ...
                                            {/* Stock add  Success */}
                                            <div className={statementSuccess ? "otp-alert mb-20" : "hidden"} style={{padding:'0.5rem'}}>
                                                <div className="flex otp-validated justify-between space-x-1">
                                                    <div className="flex">
                                                        ...
                                                        <div className="text-sm text-green-900">{statementSuccess}</div>
                                                    </div>
                                                </div>
                                            </div>
                                            {/* End */}
                                            ...
                                            <div className='flex justify-between space-x-10 mb-30'>
                                                <div className='w-1/2'>
                                                    ...
                                                    <div className='flex justify-between items-center border-1-d6 rounded-lg'>
                                                        <div className='w-full'>
                                                            <input type="text" value={startDate} onChange={e => setStartDate(e.target.value)} className="font-bold outline-white border-0 p-3 input text-sm" placeholder="DD - MM - YYYY" />
                                                        </div>
                                                ...
                                                <div className='w-1/2'>
                                                    ...
                                                    <div className='flex justify-between items-center border-1-d6 rounded-lg'>
                                                        <div className='w-full'>
                                                            <input type="text" value={endDate} onChange={e => setEndDate(e.target.value)} className="font-bold outline-white border-0 p-3 input text-sm" placeholder="DD - MM - YYYY" />
                                                        </div>
