    ...
    return (
        <div className="relative">
            ...
            <div className={showAddToWatchlistModal ? "success-modal" : "hidden"}>
                ...
                <div className="relative z-10 text-color-1 font-gotham-black-regular text-28 text-center mb-20">Add stocks to watchlist</div>

                <div className="text-color-4 text-16 text-center mb-14">Are you sure you want to add this stocks from your watchlist?</div>
            ...
            <div className={showSuccess ? "success-modal" : "success-modal hidden"}>
                ...
                <div className="text-color-4 text-16 text-center mb-14">{apiResponseMessage}</div>
